...
private:
	...
	UPROPERTY(Category = "Properties	| Lighting",	EditAnywhere, meta = (ToolTip = "Lux",	Delta = "0.25",	ClampMin = "0.0",	ClampMax = "100.0", UIMax = "10.0"	)	) float									SunLightIntensity			= 4.0f;
	UPROPERTY(Category = "Properties	| Lighting",	EditAnywhere, meta = (ToolTip = "Lux",	Delta = "0.05",	ClampMin = "0.0",	ClampMax = "100.0", UIMax = "1.0"	)	) float									MoonLightIntensity			= 0.225f;
	...
	UPROPERTY(Category = "Properties	| Time",		EditAnywhere																										) uint8									bFreezeManualTime	: 1		= true; // TODO: false
